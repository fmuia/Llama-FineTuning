...
\quad\right) . \\
%    \Gamma_{\text{\tiny{eq}}}(l)\simeq & \kappa l^{2-d/2} \lr{\int_\varepsilon^\infty {dx \, \frac{e^{-x l/L}}{x^{d/2}}}+\frac{1}{2}\int_\varepsilon^{1-\varepsilon}{dx\, x^{-d/2}(1-x)^{d/2}}}\\
%    &=\kappa l^{2-d/2}\lr{\frac{1}{2}B\lr{1-\varepsilon;1-\frac{d}{2},1-\frac{d}{2}}-\frac{1}{2}B\lr{\varepsilon;1-\frac{d}{2},1-\frac{d}{2}}+\lr{\frac{l}{L}}^{d/2-1}\Gamma\lr{\frac{l\varepsilon}{L};1-\frac{d}{2}}}\, ,
\end{split}
\end{equation}
