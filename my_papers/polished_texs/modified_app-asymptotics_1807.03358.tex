...
We wish to find the constant coefficient of \prettyref{eq:airy-approx} which will make it agree with $\textrm{Re}(w(x))$ from \prettyref{eq:wh-re} as $x\to0$, or equivalently as $\zeta\textrightarrow-\infty$. 
